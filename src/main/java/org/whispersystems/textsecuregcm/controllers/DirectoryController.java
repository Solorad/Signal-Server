...
@Path("/v1/directory")
@Api(value = "/v1/directory", description = "Operations with directory")
public class DirectoryController {
    ...
    @GET
    @Path("/{token}")
    @ApiOperation(value = "Get token presence", notes = "Get token presence")
    ...
    @PUT
    @Path("/tokens")
    @ApiOperation(value = "Get contact intersection", notes = "Get contact intersection")
    @Produces(MediaType.APPLICATION_JSON)
